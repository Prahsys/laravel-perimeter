...
test('it creates dto from malware scan', function () {
    ...
    $data = $service->resultToSecurityEventData($malwareScanResult);
...
test('it creates dto from vulnerability scan', function () {
    ...
    $data = $service->resultToSecurityEventData($vulnerabilityScanResult);
...
test('it creates dto from behavioral analysis', function () {
    ...
    $data = $service->resultToSecurityEventData($behavioralResult);
...
test('it creates dto with missing data', function () {
    ...
    expect($data->getUser())->toBeNull();
    expect($data->getScanId())->toBeNull();
...
test('it converts to array', function () {
    ...
    expect($array['service'])->toBe('test_service');
    expect($array['scan_id'])->toBe(123);
